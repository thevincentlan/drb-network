...
function getApprovalRecipient() {
  ...
  // Fallback removed to prevent fatal permission errors when not deployed by the owner.
  // The script will now return empty string, gracefully failing and returning
  // "Approval email is not configured for this deployment." to the client.
  return '';
}
